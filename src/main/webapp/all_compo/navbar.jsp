...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href="#"><i class="fa fa-book"
		aria-hidden="true"></i>EverNotes</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<a href="register.jsp" class="btn btn-light  my-2 my-sm-0 mr-3"
			type="submit"><i class="fa fa-sign-in" aria-hidden="true"></i>Register</a>
		<a href="admin.jsp" class="btn btn-light  my-2 my-sm-0 mr-3"
			type="submit"><i class="fa fa-user" aria-hidden="true"></i>Admin</a>
		<%
		}
		%>
